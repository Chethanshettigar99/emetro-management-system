...
<form> 
    ...
    <a href="release-train.php" class="register"> Release New Metro </a><br><br><br>
    <a href="view-trains.php" class="register">View Metro</a><br><br><br>
    <a href="view-status.php" class="register">View Metro Status</a><br><br><br>
