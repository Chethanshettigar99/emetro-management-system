...
<form action="book-ticket.php" method="POST">
    ...
    <label>
    <p class="label-txt">Metro NUMBER</p>
    ...
    <p class="label-txt">COACH&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      <input type="radio" name="coach" value="ac" checked>&nbsp&nbsp&nbspPREMIUM</input>&nbsp&nbsp&nbsp
      <input type="radio" name="coach" value="sleeper">&nbsp&nbsp&nbspCOMFORT</input></p><br>
    </label>
    <label>
